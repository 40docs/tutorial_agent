...
// Act 4: Agentic loop + Context Compaction + Audit Log
const ACT4_RECTS = {
  ...
  [C.COMPACTOR]:  { x: 30,  y: 420, w: 150, h: 56, label: 'Context Compaction', colorKey: 'compaction' },
